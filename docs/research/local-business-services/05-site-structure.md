...
| `/blog/google-review-removal-uk-rules`          | Post (#13, drafted S7)  | New         | 4 / Blog        | Yes — drafted S7, 25 September 2026; row 93 kept                                                                                                                                                                                                                                                                             | primary (1 · 1)                                                                                                      |
| `/blog/ai-receptionist-vs-answering-service-uk` | Post (#14, drafted S7)  | New         | Blog            | Yes — drafted S7, 25 September 2026; takes the live row `ai receptionist vs answering service uk` when live (§ 3)                                                                                                                                                                                                            | not in the draft — its term is a live row, re-pointed on the day the post exists                                     |
| `/blog/sales-funnel-or-landing-page-uk`         | Post (#15, drafted S7)  | New         | Blog            | Yes — drafted S7, 25 September 2026; row kept                                                                                                                                                                                                                                                                                | primary (1 · 1)                                                                                                      |
| `/blog/check-google-maps-ranking-uk`            | Post (#16, drafted S7)  | New         | Blog            | Yes — drafted S7, 25 September 2026; row kept                                                                                                                                                                                                                                                                                | primary (2 · 2)                                                                                                      |
| `/blog/missed-call-text-back-tools-uk-compared` | Post (#17, second wave) | New         | Blog            | No — second wave (decided 25 September 2026); row 97 and outline AJ.17 kept                                                                                                                                                                                                                                                  | primary (1 · 1)                                                                                                      |
