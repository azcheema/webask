...
| 3   | CMA208: suppressing, selectively promoting, "encouraging just those who are satisfied", stop-start invitations = misleading presentation (Sch 20 banned practice, §§ 4.3–4.5); "merely emailing customers generally to ask if they wish to provide a review" is allowed (§ 3.6); incentivised reviews "must be clearly identifiable as incentivised", usually by a prominent label "as an advert" (§§ 3.5, 3.7; modality corrected 25 September 2026 on the PDF); the duty is non-delegable; a second-party publisher must check the first party's arrangements; marketing companies acting for traders are in breach of the banned practice when they commission (§ 3.3, "will be in breach of the banned practice" — "commit the offence" corrected 25 September 2026 on the PDF; Schedule 20 is civilly enforced). **Google Maps policy (2026-09-24; re-read 25 September 2026): merchants "should not" — the page's own modality, "must not" corrected 25 September 2026 — "Discourage or prohibit negative reviews, or selectively solicit positive reviews from customers", nor "Offer incentives … in exchange for posting any review", nor pressure users to review on the premises.** (high)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | Review Management: ask everyone, no two-step "rate us first" flows, no incentives at all, no on-premises pressure, replies human-approved, widget shows everything; WebAsk's own operator exposure stated in 02.                                                                                                                                                                                                                                                                                         | none material — Google's policy now checked                                                                                                         |
...
⚠️ **Modality.** Reg 6(1)(e) excludes contracts "for the construction of new buildings, or the
construction of substantially new buildings by the conversion of existing buildings" — quote it before
a builder's page states the 14-day rule as universal. **Resolved 24 September 2026 (S4, `06` L.3.2):**
Part 3 carries its own floor, reg 27(3) — "This Part does not apply to off-premises contracts under
which the payment to be made by the consumer is not more than £42" — so the £42 sentence in copy must
say that both the information duties and the right to cancel fall away for an off-premises job of £42
or less, and that a distance contract (a quote accepted by phone, text, email or website) has no
floor. R47's "Never" clause and the two trades drafts that carried the earlier reading were corrected
the same day.
...
- **CMA208** (4 April 2025) [S26]: § 3.3 names "marketing companies, individuals acting on behalf
  of traders" among those who "will be in breach of the banned practice" by commissioning (the guidance's words; "commit the offence" corrected 25 September 2026 — Schedule 20 is civilly enforced); § 3.6 — asking "without
  ...
  practice"; §§ 3.5, 3.7 — an incentivised review "must be clearly identifiable as incentivised", and "Usually, it will be necessary for the reviewer at least to label the review prominently as incentivised, namely, as an advert" (the modality as the PDF prints it, confirmed 25 September 2026); § 4.4(iii) "arbitrarily stopping and starting review invitations"; § 4.5
...
- **Google's Maps user-contributed content policy** (read 24 September 2026; re-read 25 September 2026) [S38]: merchants "should not" — the page's word; "must not" corrected 25 September 2026 — "Discourage or prohibit negative reviews, or selectively solicit positive reviews from
...
| R15 | **Use:** "We run no incentivised requests. Where a business does, the CMA's guidance says the review must be clearly identifiable as incentivised — usually by a prominent label, as an advert." **Never:** "incentives are illegal" (over-claim), never "a small thank-you is fine".                      | CMA208 §§ 3.5, 3.7; GDC for dentists (doc 03 § B2)                                                                                                          | Guidance: "must be clearly identifiable as incentivised"; the label "prominently … as an advert" is what the CMA says is "usually" necessary (§ 3.5, confirmed on the PDF 25 September 2026; the earlier "requires … to be labelled" corrected); concealment is the banned practice. Dental: "no incentives at all" is the GDC's rule, stated only on dental pages. |
...
| R17 | **Use:** "The guidance names marketing companies acting for a business among those who would be in breach of the banned practice — which is why our flow is built this way." **Never:** imply WebAsk is outside the rules because the reviews are the client's.                                            | CMA208 § 3.3                                                                                                                                                | Guidance: commissioning liability is stated in § 3.3's words, "will be in breach of the banned practice" ("commit the offence" corrected 25 September 2026); the copy owns it rather than hiding it.                                                                                                                                                                |
...
| R25 | **Use:** the opening line in J.7: it names the business, says it is an automated assistant, says the call is recorded whenever recording is on (off by default — D4, 25 September 2026), and offers a person. **Never:** an agent that lets callers assume it is human.    | Practice, built on ICO fairness (recording) and the DMCC misleading-action rules (a caller misled about who they are talking to); doc 03 § B3 | **No UK statute specific to AI-voice disclosure was found (rows 6, 9).** Say "we disclose it in the first sentence", never "the law requires an AI to identify itself".                           |
...
With recording on (off by default — D4, 25 September 2026): Hello, you've reached {Business}. I'm an automated assistant, and this call is recorded. I can book an appointment or take a message, and I can put you through to a person. How can I help?
```
...
| R52 | **Use:** "An MOT or service reminder that says when it is due and how to book is a service message. Drivers of cars, vans and motorcycles can sign up on GOV.UK for a free reminder a month before, so yours earns its place with the booking link and your price, not with an offer." **Never:** an offer inside the reminder; never "beat the DVSA reminder"; never a reminder to a number that was never a customer's.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | ICO service-message test (S03; R08); GOV.UK "Get MOT reminders" (S122; re-read 25 September 2026: cars, vans and motorcycles at one month, lorries, buses and large trailers at two — "any driver" corrected the same day)                  | Guidance plus a GOV.UK statement of fact; the DVSA timing quoted as "one month before".                                                                                                                                                     |
