...
| Gyms / fitness studios   | 4       | 2               | 3                | 3           | 3      | 5      | 3       | —       | 56               | DMCC subscription regime — the DBT response (2 Apr 2026) says "we anticipate that the regime will commence in spring 2027"; "gym membership marketing" thin (App. G) — on Google 7/9 UK and Medium, a software-and-payments SERP with one gym-marketing company and no agency (`03` `serp-0103`); CMA gym-contract enforcement 2011–2016 now sourced and the DBT response read in full (App. AP: "we anticipate that the regime will commence in spring 2027")                                                                                                                                                                             |
