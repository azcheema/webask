...
<Callout variant="note" title="TL;DR">
  ...
  and automation in one place. Plans run from USD $97 to $497 a month, plus usage. It's a strong fit
  for service businesses and agencies; it's overkill if you only need a simple contact list.
</Callout>
...
<Callout variant="warning">
  ...
  GoHighLevel's $97 to a rival's flat fee as if they are the same thing.
</Callout>
