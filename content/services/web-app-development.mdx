...
description: "Internal tools, customer portals, and dashboards built on a typed, production-grade stack — auth, roles, and audit logging baked in. Starting at £9,500."
...
## What a WebAsk web application does differently
...
Refer to the price card on this page for the included scope at £9,500 starting. In short: discovery and design before any code, a typed Next.js implementation with authentication and role-based access, hosting and CI and observability stood up on your accounts, and a documented handoff so your team can run it.
...
## How we build a WebAsk web application
...
|            | Custom app (WebAsk)                      | Off-the-shelf SaaS                  | No-code (Airtable, Retool, Bubble)           |
| ---------- | ---------------------------------------- | ----------------------------------- | -------------------------------------------- |
...
Honesty about scope is half the value of a service page. For WebAsk web applications, the most common asks we do not take at the starting price:
