...
| 1 — Credible MVP + Cutover               | **In progress** | Started 2026-09-25 on `feature/phase-1-legal-uk`: the three legal documents rewritten for UK GDPR/PECR (`draft: true` pending founder review + D3), the consent banner brought to equal prominence, the fork's naxdor.com lead-inbox and sender defaults replaced. Fabricated content is confirmed absent from the tree; it dies at cutover. Remaining: the network-tab consent check on a preview with real IDs, then the external cutover steps                                                                                                                                                                                                                                                                                                                                                                     |
