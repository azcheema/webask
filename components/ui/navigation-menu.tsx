...
function NavigationMenuLink({ className, ...props }: NavigationMenuPrimitive.Link.Props) {
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        "hover:bg-accent focus:bg-accent focus-visible:ring-ring/50 data-active:bg-accent/50 data-active:hover:bg-accent data-active:focus:bg-accent flex items-center gap-2 rounded-lg p-2 text-sm transition-all outline-none focus-visible:ring-3 focus-visible:outline-1 in-data-[slot=navigation-menu-content]:rounded-md [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    />
