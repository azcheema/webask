...
function SelectItem({ className, children, ...props }: SelectPrimitive.Item.Props) {
  return (
    <SelectPrimitive.Item
      ...
      // Base UI Select keeps focus on the listbox and marks the active option
      // (pointer-hover OR keyboard arrow) with `data-highlighted` — it does NOT
      // move DOM focus to items the way Base UI Menu does. The stock shadcn
      // template's `focus:bg-accent` is Radix-oriented and never matches here, so
      // we drive the highlight off `data-[highlighted]` instead.
      className={cn(
